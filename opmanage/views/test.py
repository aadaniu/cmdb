...
def insert_data(requets):
    ...
    """
    try:
        # Department_info.objects.create(department_name='op',department_leader='why',department_email='op@whysdomain.com')
        # Serverline_info.objects.create(serverline_name='shop-api-order',serverline_leader='n',serverline_op_leader='wanghongyu',department_id='2')
        # Serverline_info.objects.create(serverline_name='dwxk-api-cart',serverline_leader='g',serverline_op_leader='u',department_id='2')
